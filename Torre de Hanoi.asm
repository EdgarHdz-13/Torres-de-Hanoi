...
.text
		...
		addi	$s0,$zero,100				#Tamaño de la torre de hanoi
...
apilar:		#(t0 = Dato, t1 = Torre de Hanoi  1, 2 ,3  t9 = borra)
		addi	$t9,$zero,1
		bne	$t1,$t9,case_2_a
...
desapilar:	#(t0 = Torre de Hanoi  1, 2 ,3  Borra t1, Y se guarda el dato en t0 lo cual ayudará después)
		addi	$t9,$zero,1
		bne	$t0,$t9,case_2_d
		lw	$t0,0($s1)
		sw	$zero,0($s1)
